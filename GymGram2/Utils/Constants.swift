...
// refrence to User (Name , Username, profile image URL)
let USER_REF = DB_REF.child("authResult")

//refrence to user followers and follwoing
...
let USER_FEED_REF = DB_REF.child("user-home")
