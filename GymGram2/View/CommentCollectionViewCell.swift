...
class CommentCollectionViewCell: UICollectionViewCell {
    ...
    /*
     ...
     if i did Comment with UITextView  it will let the user to edit the comment for other user but without save it
     commentLabel will not let the user edit the comments but i can do isScrollEnabled
     */
