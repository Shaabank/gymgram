...
//  Gymgram
//
//  Created by Kamel Shaaban on 19/01/2023.
//
...
enum FollowState {
    case following // the current user not following the other user
    case not_following // the current user is not following the otehr user 
}
...
class UserFollowTableViewCell: UITableViewCell {
    ...
    public func configure(with model: UserRelationship){
        ...
        switch model.type {
        case .following:
            // here should show the user unfollow button
        ...
        case .not_following:
            //here should show the user follow button
